...
userRouter.post('/user-payment-pass/validate', UserAuth, UserController.validatePaymentPass)

userRouter.put('/user-payment-pass/update', UserAuth, UserController.updatePaymentPass)
