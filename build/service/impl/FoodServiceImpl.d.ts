...
export default class FoodServiceImpl implements FoodService {
     ...
     * @returns {any} 是否添加成功
     */
    addFood(food_name: string, price: number, status: boolean, description: string, isdelete: number, destination: string, path: string, filename: string): Promise<boolean>;
    /**
     * Description 更新菜品信息
     ...
     */
    getFoodData(): Promise<boolean | Food[]>;
    /**
